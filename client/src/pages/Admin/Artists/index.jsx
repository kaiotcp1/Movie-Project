...
function Artists() {
  ...
  const columns = [
    {
      ...
      render: (text, record) => {
        ...
        return <img src={imageUrl} alt="" className="w-20 h-20 rounded object-cover" />;
      },
    },
    {
      title: "Name",
  ...
  return (
    <div>
      ...
      <Table dataSource={artists} columns={columns} className="mt-5 overflow-x-auto" rowKey="_id" />
